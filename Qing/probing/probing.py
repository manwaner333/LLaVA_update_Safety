...
def train(model, criterion, optimizer, train_loader, test_loader, num_epochs, device):
    ...
    for epoch in range(num_epochs):
        ...
        if f1 > best_f1:
            ...
            # np.save('result/self_data/llava_v15_7b_self_data_scores.npy', all_outputs_prob)
            # np.save('result/self_data/llava_v15_7b_self_data_labels.npy', all_labels)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", type=str, default='mhal')   # pope_pop, mhal, self_data
    parser.add_argument("--model", type=str, default='llava15_7b')  # llava16_moe, llava15_7b, llava16_7b
    ...
    test_loader = get_val_data_loaders(args.dataset, model_name=args.model, feature_key=args.feature_key,
                                          batch_size=args.bs)
