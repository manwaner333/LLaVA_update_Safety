...
class ModelHelper:
    ...
    def get_logits(self, input_ids, image_tensor, image_size):
        with torch.no_grad():
            logits = self.model(input_ids, images=image_tensor, image_sizes=[image_size]).logits
            return logits
...
if __name__ == "__main__":
    ...
    model_helper.set_save_internal_decodings(True)
