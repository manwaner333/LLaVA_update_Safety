...
mul_path = f'result/m_hal/{model_version}_answer_synthetic_val_data_from_M_HalDetect_multiple.bin'
answers_file = f'result/m_hal/{model_version}_answer_self_check_synthetic_val_data_from_M_HalDetect_n_gram_2.bin'
