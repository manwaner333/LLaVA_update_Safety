        ...
        with open(in_file, "r", encoding="utf-8") as f:
            ...
            for idx, line in enumerate(content):
                ...
                if args.sm == "True":
                    ...
                    print(f"string_score:{not sm_score}")
                    if not sm_score:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--in_file', type=str, default="result/safebench/llava-v1.5-7b_safebench_origin_model_without_images.json")
